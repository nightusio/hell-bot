    ...
    public @NonNull SlashCommandCreateListener respond() {
        return event -> {
            ...
            EmbedBuilder embed = new EmbedBuilder()
                    .setTitle("HellHard | Tickety")
                    .setDescription("Wybierz jedna z ponizszych opcji aby stworzyc ticket!")
                    .addField("", "")
                    .addField("Informacja", "Bezpodstawne tworzenie ticketow bedzie skutkowac banem!")
                    .setFooter("HellHard | 2023")
                    .setAuthor(event.getApi().getYourself())
                    .setImage("https://media.discordapp.net/attachments/1157576834108641304/1162827830913146890/tickety.png?ex=653d5acf&is=652ae5cf&hm=5d7129fff359f1381c6a7165b3f5e90f5477d5c586d29fc98678391ab87eb1f4&=&width=1192&height=366")
