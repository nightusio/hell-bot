...
public class TicketAddUserCommand extends JavacordCommand {
    ...
    @Inject
    public TicketAddUserCommand(TicketManager ticketManager) {
        super("add", "Dodaje wybrana osobe do ticketa.");
        ...
        List<SlashCommandOption> optionList = new ArrayList<>(Collections.singletonList(
                ...
                SlashCommandOption.create(SlashCommandOptionType.USER, "user", "Osoba ktora chcesz dodac do ticketa", true)
        ));
