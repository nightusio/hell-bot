...
import me.night.helldev.config.TokenConfig;
...
import me.night.helldev.functionality.poll.command.PollReloadCommand;
...
public class HellBot extends DreamJavacordPlatform implements DreamPersistence, DreamJavacordConfig {
    ...
    public void enable(@NonNull ComponentManager componentManager) {
        ...
        componentManager.registerComponent(PollReloadCommand.class);
