package me.night.helldev.functionality.ticket.impl;
...
public class TicketHandler {
    ...
    public void createNewTicketChannel(Server server, User user, ChannelCategory category, String buttonTicketClose, String ticketName, SharedType sharedType) {
        ...
        Ticket ticketToCreate = new Ticket(user.getId(), sharedType, channel.getIdAsString());
